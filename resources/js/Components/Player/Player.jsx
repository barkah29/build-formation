...
const Player = (props) => {
    const { color, bodyColor, armColor, height, width, className, avatar } =
        props;
        ...
        <>
            {avatar ? (
                <div className="h-full w-full">
                    <img
                        src={avatar}
                        className={`"object-cover w-[35px] h-[35px] brightness-60 rounded-full`}
                        alt=""
                        style={{
                            border: `solid 2px ${bodyColor}`,
                        }}
                    />
                </div>
            ) : (
                <svg
                    ...
                    className={`jersey-svg ${className}`}
                >
                    <defs>
                        <radialGradient
                            cx="52.64281%"
